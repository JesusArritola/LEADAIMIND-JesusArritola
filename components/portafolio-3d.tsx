    ...
    <div className="min-h-screen relative bg-[#0c1324]">
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center py-16 md:py-20 px-4 md:px-8 lg:px-12">
        <div className="max-w-xl lg:max-w-2xl">
          ...
          >
            <a
              href="mailto:jesusarritola@gmail.com"
          ...
          <div className="relative bg-[#151b2d] rounded-2xl border border-[#3a4a43]/30 max-w-2xl w-full max-h-[80vh] overflow-y-auto p-6">
            ...
            <div className="grid grid-cols-1 gap-3">
              {certificados.map((cert, i) => (
                <div key={i} className="flex items-center justify-between p-4 rounded-xl bg-[#0c1324]/50 border border-[#3a4a43]/20 hover:border-[#00FFC2]/40 transition-all group cursor-pointer"
                ...
                >
                  <div className="flex items-center gap-4 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="text-xs text-[#dce1fb]/50">Clic para ver detalles</span>
                    </div>
                  </div>
                  <div className="flex gap-1 flex-shrink-0 ml-2">
                    <a
                      href={cert.file}
                      download
                      className="p-2 rounded-lg text-[#dce1fb]/40 hover:text-[#00FFC2] hover:bg-[#00FFC2]/10 transition-all"
                      title="Descargar"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#151b2d] rounded-2xl border border-[#3a4a43]/30 w-full max-w-4xl h-[90vh] overflow-hidden">
            <div className="flex items-center justify-between p-4 border-b border-[#3a4a43]/20">
              ...
              <div className="flex gap-2">
                <a
                  ...
                  download
                  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#00FFC2]/20 text-[#00FFC2] hover:bg-[#00FFC2]/30 transition-all text-sm"
                >
                  <Download className="w-4 h-4" />
                  Descargar
                </a>
            ...
            <div className="h-[calc(100%-72px)]">
              <iframe
                src="/CV_Jesus_Miguel_Arritola.pdf"
                className="w-full h-full"
                title="CV Jesús Miguel Arritola"
              />
            </div>
          </div>
        </div>
